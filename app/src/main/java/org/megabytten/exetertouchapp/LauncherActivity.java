...
import org.megabytten.exetertouchapp.database.MySQLConnection;
...
public class LauncherActivity extends AppCompatActivity {
    ...
    private void loginButtonWorkerThread() throws IOException{
        ...
        if (responseCode == HttpURLConnection.HTTP_OK) { //success
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    Toast.makeText(LauncherActivity.this, "Email Address not Recognised. Please re-enter Email or Sign up below,",
    ...
    private void userInit (String email, String password) throws IOException {
        ...
        if (responseCode == HttpURLConnection.HTTP_OK) {
            ...
            //User.createInstance(email, firstName, lastName, phoneNumber, password);
            User.createInstance(email, info[0], info[1], info[2], password);
    ...
    private void checkVerification() throws IOException {
        //todo: NEED TO PULL DATA AND INITIALISE USER BEFORE THIS!!!
