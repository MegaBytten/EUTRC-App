...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.MyViewHolder>{
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public TextView trainingTitleTxt, id, date, team, location, drills;
        public Button available, unavailable;
        public LinearLayout linLay, rsvpContainer;
        ...
        public MyViewHolder(final View view){
            ...
            rsvpContainer = view.findViewById(R.id.RSVPContainer);
            available = view.findViewById(R.id.availableBtn);
            unavailable = view.findViewById(R.id.unavailableBtn);
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerAdapter.MyViewHolder holder, int position) {
        ...
        holder.rsvpContainer.setVisibility(View.GONE);
